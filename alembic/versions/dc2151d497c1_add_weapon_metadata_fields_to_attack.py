...
def upgrade() -> None:
    ...
    with op.batch_alter_table('attacks', schema=None) as batch_op:
        batch_op.add_column(sa.Column('damage_type', sa.String(length=50), nullable=True))
        batch_op.add_column(sa.Column('weapon_category', sa.String(length=20), nullable=True))
        ...
        batch_op.add_column(sa.Column('two_handed_damage', sa.String(length=20), nullable=True))
