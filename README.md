...
2. **Create a character** — `/character create` opens a hub-based wizard. A central hub shows all sections (Name, Class & Level, Ability Scores, AC, Saving Throws, Skills, HP, Weapons) as buttons — green when configured, red when not. Visit any section in any order, save and return to the hub, or discard changes. Name is required; all other sections are optional. **Save & Exit** commits the character when you're ready.
...
|--------------|----------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/character` | `create`, `delete`, `switch`, `view`, `list`, `list_all`, `stats`, `skill`, `ac`, `class`, `saves`                   | `/character create` opens a hub-based wizard: visit Name, Class & Level, Ability Scores, AC, Saving Throws, Skills, HP, and Weapons in any order; sections show green/red to indicate completion; Name is required to save. Can have multiple characters; use `view` for the paginated sheet. `list_all` shows every character in the server across all players. |
...
| `/weapon`    | `search`                                                                                                             | Searches the SRD and adds weapons directly to your active character with computed hit modifiers. Also available in the Weapons section of the character creation wizard. |
