...
|--------------|----------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/character` | `create`, `delete`, `switch`, `view`, `list`, `stats`, `skill`, `ac`, `class`, `saves`                               | `/character create` opens a hub-based wizard: visit Name, Class & Level, Ability Scores, AC, Saving Throws, Skills, HP, and Weapons in any order; sections show green/red to indicate completion; Name is required to save. Can have multiple characters; use `view` for the paginated sheet. |
