"""Character creation wizard entry point.

Exports ``start_character_creation`` for use by the character command cog.
Also exports ``_show_hub`` and ``_finish_wizard`` for use by section views
and modals that need to navigate back to the hub or commit the wizard.
"""
...
from commands.wizard.hub_view import HubView, _build_hub_embed
...
# ---------------------------------------------------------------------------
# Completion embed helpers (also used by the wizard intro / legacy path)
# ---------------------------------------------------------------------------

# Re-import constants needed for the completion embed
from commands.wizard.state import _ALL_STATS, _STAT_DISPLAY  # noqa: E402
